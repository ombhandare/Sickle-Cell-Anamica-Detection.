...
def test_model_proc(fn):
    ...
    if fn!="":
        ...
        return A
    img = open(fn)    
    myfile = open("C:/Users/bhand/Downloads/23CP165-Sickel cell detection/testing")
    if img == myfile:
          print(myfile)
...
def openimage():
    ...
    fileName = askopenfilename(initialdir='D:/Code/Road Damage Detection/testing', title='Select image for Analysis',
    ...
    try:
        ...
        fn = fileName  # Update the global variable with the valid file path

    except Exception as e:
        # Handle invalid or non-image file
        error_msg = f"Error: {str(e)}\nPlease select a valid image file."
        update_label(error_msg)
# def openimage():
